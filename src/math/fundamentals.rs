...
mod tests {
    ...
    fn should_return_correct_type() {
        let mut t: Tuple = Tuple {x: 4.3, y: -4.2, z: 3.1, w: 1.0};
        assert_eq!(4.3, t.x);
        assert_eq!(-4.2, t.y);
        assert_eq!(3.1, t.z);
        assert_eq!(1.0, t.w);
        ...
        t = Tuple {x: 4.3, y: -4.2, z: 3.1, w: 0.0};
        assert_eq!(4.3, t.x);
        assert_eq!(-4.2, t.y);
        assert_eq!(3.1, t.z);
        assert_eq!(0.0, t.w);
    ...
    fn should_create_correct_types() {
        let mut reference = Tuple {x: 4.0, y: -4.0, z: 3.0, w: 1.0};
    ...
    fn should_add_components_correctly() {
        ...
        let reference = Tuple {x: 1.0, y: 1.0, z: 6.0, w: 1.0};
    ...
    fn should_negate_tuple_properly() {
        ...
        let reference = Tuple {x: -1.0, y: 2.0, z: -3.0, w: 4.0};
    ...
    fn should_multiply_by_scalar_correctly() {
        let a = Tuple {x: 1.0, y: -2.0, z: 3.0, w: -4.0};
        let reference = Tuple {x: 3.5, y: -7.0, z: 10.5, w: -14.0};
    ...
    fn should_multiply_by_fraction_correctly() {
        let a = Tuple {x: 1.0, y: -2.0, z: 3.0, w: -4.0};
        let reference = Tuple {x: 0.5, y: -1.0, z: 1.5, w: -2.0};
